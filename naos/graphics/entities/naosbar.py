...
class NaOSBar:
    ...
    def show(self, screen):
        ...
        pygame.draw.line(screen, Color.from_name("BLACK").get_rgba(), (self.naos.width - self.hour.get_rect().width - 10, self.naos.height - 33), (self.naos.width - self.hour.get_rect().width - 10, self.naos.height), 3)
        screen.blit(self.hour, (self.naos.width - self.hour.get_rect().width - 5, self.naos.height - 16 - self.hour.get_rect().height/2))